...
int main(int argc, char **argv) {
  ...
  params.DISPATCH_X = ceil((float)width / (WORKGROUPSIZE_X * 4));
  params.DISPATCH_Y = ceil((float)height / (WORKGROUPSIZE_X));
  params.DISPATCH_Z = 1;
  ...
  params.shader_path = "shaders/add_vec4/add_vec4.comp.spv";
